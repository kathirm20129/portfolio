...
//   return (
//     <div className="absolute left-6 bottom-10 z-[999] flex flex-col items-center gap-3">
//       <p className="text-white/70 text-sm tracking-widest">PRESS BACK</p>

//       <button
//         className="w-12 h-12 border border-white/20 rounded-xl flex items-center justify-center hover:bg-white/10 transition"
//         onClick={onBack}
//       >
