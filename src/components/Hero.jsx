...
//     if (projectInfoOpen || experienceInfoOpen || contactOpen || open) return;
...
//   return (
//     <section
//       className="relative w-full min-h-screen overflow-hidden bg-cover bg-center transition-all duration-700 ease-in-out"
...
//           }}
//           className="px-5 py-2 text-sm tracking-wider border border-white/30 rounded-full neon-text hover:bg-white/10 transition"
//         >
//           CONTACT ME
//         </button>
//       </div>
...
//       {/* Scroll hidden when: info panels or contact open */}
//       {!contactOpen &&
//         !projectInfoOpen &&
//         !experienceInfoOpen &&
//         !open && (
...
//               <ClickToOpen onClick={() => setOpen(true)} />
//             </motion.div>
//           )}

//         {/* INFO PANEL */}
//         {open && !skillsOpen && !projectsOpen && !experienceOpen && !contactOpen && (
//           <motion.div
//             key="info"
...
//         {/* SKILLS */}
//         {skillsOpen && !projectsOpen && !experienceOpen && !contactOpen && (
//           <motion.div
//             key="skills"
...
//             className="absolute inset-0 z-20 flex justify-center items-start pt-[280px]"
//           >
//             <SkillsSection />
//           </motion.div>
//         )}
...
//         {/* PROJECTS */}
//         {projectsOpen && !projectInfoOpen && !experienceOpen && !contactOpen && (
//           <motion.div
//             key="projects"
...
//         {/* EXPERIENCE */}
//         {experienceOpen && !experienceInfoOpen && !contactOpen && (
//           <motion.div
//             key="experience"
//             initial={{ opacity: 0, y: 140 }}
//             animate={{ opacity: 1, y: 0 }}
