...
//   return (
//     <div className="absolute inset-0 w-full h-full z-[200] overflow-y-auto pt-24 pb-20">
...
//       <button
//         onClick={onBack}
//         className="absolute top-6 left-6 text-white text-lg tracking-wider hover:opacity-70 transition"
//       >
//         ← GO BACK
//       </button>
...
//           <label className="text-white text-xl tracking-wider">EMAIL :</label>
//           <input
//             type="email"
//             placeholder="yourname@gmail.com"
//             className="w-full h-12 rounded-md bg-white/10 border border-white/20 text-white px-4 "
//           />
//         </div>

//         {/* SUBJECT */}
//         <div className="flex flex-col gap-2">
//           <label className="text-white text-xl tracking-wider">SUBJECT :</label>
//           <input
//             type="text"
...
//         {/* CONTENT */}
//         <div className="flex flex-col gap-2">
//           <label className="text-white text-xl tracking-wider">CONTENT :</label>
//           <textarea
//             rows={6}
...
//             rounded-xl 
//             neon-text tracking-widest text-lg
...
export default function ContactPage({ onBack }) {
  return (
    ...
    <div className="absolute inset-0 w-full h-full z-[200] overflow-y-auto pt-16 pb-16 sm:pt-24 sm:pb-20">
      ...
      {/* Back Button - Adjusted positioning and text size */}
      <button
        onClick={onBack}
      ...
      {/* CONTACT FORM - Adjusted gap and input size */}
      <div className="w-full max-w-3xl mx-auto px-6 flex flex-col gap-8 sm:gap-10">
        ...
        {/* SUBMIT BUTTON - Adjusted size and text size */}
        <button
          className="
            w-full py-3 sm:py-4 
            bg-white/10 border border-white/30 
