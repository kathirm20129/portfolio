...
//   return (
//     <div 
//       className="absolute right-6 bottom-12 z-40 hidden md:flex flex-col items-center gap-3 cursor-pointer"
...
export default function ScrollIndicator({ onScrollClick }) {
  return (
    <div 
      // FIXED: Removed 'hidden sm:flex' and used 'flex' to ensure visibility on mobile.
      // Adjusted positioning and gap for small screens (bottom-8, gap-2).
    ...
    >
      ...
      <svg
        ...
        strokeWidth={1.5}
        stroke="currentColor"
        // Adjusted SVG size to scale up from small screens
